...
private:
    ...
    ros::NodeHandle n_;
    ros::Publisher stateA_pub = n_.advertise<driving_simulator_msgs::State>("state_A_1", 100);
    ros::Publisher action_pub = n_.advertise<driving_simulator_msgs::Action>("action_1", 100);
