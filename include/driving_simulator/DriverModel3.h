...
private:
    ...
    ros::NodeHandle n_;
    ros::Publisher stateA_pub = n_.advertise<driving_simulator_msgs::State>("state_A_3", 100);
    ros::Publisher action_pub = n_.advertise<driving_simulator_msgs::Action>("action_3", 100);
