...
#include "/home/bdebrito/code/ProbabilisticMotionPlanning-MasterThesis/POMDP/POMDP/src/POMDPrviz1.h"
...
private:
    ros::NodeHandle n_;
    ros::Publisher trajA0_pub = n_.advertise<driving_simulator_msgs::Traj>("traj_A0_1", 100);
    ros::Publisher trajA1_pub = n_.advertise<driving_simulator_msgs::Traj>("traj_A1_1", 100);
    ros::Publisher belief_pub = n_.advertise<driving_simulator_msgs::Belief>("belief_1", 100);
