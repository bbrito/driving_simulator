...
#def __init__():
'''
a Python wrapper for a fast solver generated by FORCES Pro v1.6.122
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['all_parameters'] - column vector of length 75000
...
('all_parameters', ctypes.c_double * 75000),
]
