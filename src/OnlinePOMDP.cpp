...
#include <driving_simulator/OnlinePOMDP.h>
#include <algorithm>
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber state_A_sub = n.subscribe("state_A", 100, Callback3);
    ros::Subscriber action_sub = n.subscribe("action", 100, Callback4);
