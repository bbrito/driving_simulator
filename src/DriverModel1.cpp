...
#include <driving_simulator/DriverModel1.h>
#include <fstream>
...
int main(int argc, char** argv){
    ...
    // ROS connection
    ros::init(argc, argv, "DriverModel1");
    ros::NodeHandle n;
    ros::Rate r(2.5);
    ...
    Obs_veh.color.r = 1.0f;
    Obs_veh.color.g = 1.0f;
    Obs_veh.color.b = 0.0f;
    Obs_veh.color.a = 1.0;
    ...
    Obs_veh.pose.orientation.z = sin(0);
    Obs_veh.pose.orientation.w = cos(0);
    ...
    vector<double> state_A = {initi_obs_x, initi_obs_y, 0, initi_obs_v, 0, 0};//x,y,theta,v,g,s
...
//        state_A[4]  = 0;
    ...
    //ofstream outfile;
    //outfile.open("/home/bingyu/ProMotionPlan/ICRA/1-clearance3.txt");
