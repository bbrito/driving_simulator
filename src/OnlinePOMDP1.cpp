...
*=========================================*/
  ...
  assert(solver != NULL);
   ...
   /* =========================
    ...
    hist1.pose.orientation.z = sin(0.0/2);
    hist1.pose.orientation.w = cos(0.0/2);
    hist1.header.frame_id = "/my_frame";
    hist1.ns = "trajectory1";
...
//    hist3.pose.orientation.w = cos(PI/4);
    ...
    ellips1.id = 70;
    ellips1.color.r = 1.0f;
    ellips1.color.g = 0.4f;
    ellips1.color.b = 0.0f;
    ellips1.color.a = 1.0;
    ...
    ellips2.id = 90;
    ellips2.color.r = 1.0f;
    ellips2.color.g = 0.4f;
    ellips2.color.b = 0.0f;
    ellips2.color.a = 1.0;
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber action_sub = n.subscribe("action_1", 100, Callback4);


    int count = 0;
    despot::POMDP POMDP_Planner;

    state_A = {initi_obs_x, initi_obs_y, 0, initi_obs_v, 1, 0};//x,y,theta,v,g,s
    ...
    //ofstream outfile;
    //outfile.open("/home/bingyu/ProMotionPlan/ICRA/scaling/DESPOT_1_solvetime3.txt");
    double solvetime;
    while (count <= 220)
    {
