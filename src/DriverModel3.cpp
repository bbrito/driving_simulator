...
#include <driving_simulator/DriverModel3.h>
#include <fstream>
...
int main(int argc, char** argv){
    ...
    // ROS connection
    ros::init(argc, argv, "DriverModel3");
    ros::NodeHandle n;
    ros::Rate r(2.5);
    ...
    Obs_veh.color.r = 0.5f;
    Obs_veh.color.g = 0.0f;
    Obs_veh.color.b = 0.5f;
    Obs_veh.color.a = 1.0;
    ...
    vector<double> state_A = {initi_obs_x, initi_obs_y, 0, initi_obs_v, 1, 0};//x,y,theta,v,g,s
...
//        state_A[4]  = 0;
    ...
    //ofstream outfile;
    //outfile.open("/home/bingyu/ProMotionPlan/ICRA/3-clearance5.txt");
