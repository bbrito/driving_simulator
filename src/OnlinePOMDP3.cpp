...
#include <driving_simulator/OnlinePOMDP3.h>
...
{
    // ROS connection
    ros::init(argc, argv, "DESPOT3");
    ros::NodeHandle n;
    ros::Rate r(2.5);
    ros::Subscriber trajR_sub = n.subscribe("traj_R", 100, Callback1);
    ros::Subscriber pose_R_sub = n.subscribe("pose_R", 100, Callback2);
    ros::Subscriber state_A_sub = n.subscribe("state_A_3", 100, Callback3);
    ros::Subscriber action_sub = n.subscribe("action_3", 100, Callback4);
    ...
    //ofstream outfile;
    //outfile.open("/home/bingyu/ProMotionPlan/ICRA/DESPOT_3_solvetime5.txt");
    double solvetime;
    while (count <= 220)
    {
