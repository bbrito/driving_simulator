...
#include <driving_simulator/DriverModel2.h>
#include <fstream>
...
int main(int argc, char** argv){
    ...
    // ROS connection
    ros::init(argc, argv, "DriverModel2");
    ros::NodeHandle n;
    ros::Rate r(2.5);
...
//        state_A[4]  = 0;
    ...
    //ofstream outfile;
    //outfile.open("/home/bingyu/ProMotionPlan/ICRA/scaling/2-clearance3.txt");
